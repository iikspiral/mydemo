...
<html lang="zh">
	<head>
		...
		<link rel="stylesheet" href="${ctx }/resources/css/fonts/font-awesome/font-awesome.css" />
		<link rel="stylesheet" href="${ctx }/resources/plugins/contabs/contabs.css" />

		<link rel="stylesheet" href="${ctx }/resources/plugins/ace/css/ace.css"  />
	</head>
	...
	<body class="no-skin">
		...
		<script src="${ctx }/resources/plugins/ace/js/ace.js"></script>
		<script src="${ctx }/resources/plugins/ace/js/ace.sidebar.js"></script>
